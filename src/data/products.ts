...
const products: AnyProduct[] = [
...

  {
    ...
    description: "Reliable business laptop with solid performance and essential security features.",
    specifications: {
      Processor: {
        Brand: { value: "Intel" },
      },
...

  {
    ...
    description: "Large-screen productivity laptop with slim design and strong performance.",
    specifications: {},
  },

  {
    ...
    description: "Flexible 2-in-1 laptop with AMOLED display and S Pen support.",
    specifications: {
      Dislay: {
        "Display Type": { value: "AMOLED" },
      },
