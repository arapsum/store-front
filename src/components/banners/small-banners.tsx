...
function BannerSubtitle({ subtitle, className }: { subtitle: string; className?: string }) {
  return (
    <p
      className={cn(
    ...
    <section className="flex overflow-hidden relative bg-white h-82">
      <div className="flex items-center">
        ...
        <div className="flex relative z-10 flex-col gap-4 justify-center p-8 -ml-16 bg-white">
          <h1 className="m-0 font-medium leading-10 text-black text-[49px]">PlayStation 5</h1>
      ...
      <div className="flex items-center">
        ...
        <div className="flex relative z-10 flex-col gap-2 p-4 ml-4 lg:justify-center lg:items-center bg-[#EDEDED]">
          <h1 className="m-0 text-2xl leading-10 text-black lg:text-[29px]">
            <span className="font-light lg:line-clamp-2">Apple Airpods&nbsp;</span>
    ...
    <React.Fragment>
      <div className="md:hidden">
        {mobileBanners.map((banner) => (
          <SmallBannerMobile key={`idx-banner-${banner.subtitle}`} {...banner} />
        ))}
      </div>
      <DesktopBanner />
    </React.Fragment>
