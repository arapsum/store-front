...
import type { LaptopAttribute, Product } from "#/types/product";
			...
			<section className="py-4">
				<div className="px-4 space-y-8 md:px-6 lg:space-y-0">
					...
					<section className="grid gap-8 lg:grid-cols-3">
						...
						<Gallery
							images={images}
							displayName={`${product.brand} ${product.name} - ${attributes.screenSize} - ${attributes.processor} - ${attributes.memory} RAM - ${attributes.storage} Storage - ${attributes.colour} `}
						/>
										...
										{availableColours.map((colour) => {
											...
											return (
												<button
													...
													style={{
														backgroundColor: colourToHex(colour.toLowerCase()),
													}}
												/>
											);
										})}
