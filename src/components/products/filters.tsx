    ...
    <FieldGroup>
      <Field className="flex gap-2" orientation="horizontal">
        ...
        <FieldLabel className="flex leading-6">
          <span className="text-sm font-medium text-black capitalize">{label}</span>
        ...
        <AccordionContent className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex justify-between items-center">
              ...
              <p className="text-sm font-normal leading-6 tracking-[-0.005em] text-[#A7A7A7]">To</p>
            </div>
            <div className="flex justify-between items-center">
              <input
                value={from}
  ...
  return (
    <section className="py-8 px-4 space-y-8">
      <div className="flex gap-4 items-center w-full">
        <button type="button" className="flex justify-center items-center" onClick={onClose}>
          <ChevronLeftIcon className="size-8" />
        </button>
        <h1 className="text-2xl font-medium leading-8 tracking-[0.01em]">Filters</h1>
      </div>
      {/* main */}
      <main className="flex flex-col gap-6 px-4">
        <PriceFilter from={655} to={1659} />

        <Accordion type="multiple" defaultValue={["brand"]} className="space-y-6">
...
export function MobileFilterButtons({ onFilterClick }: { onFilterClick: () => void }) {
  return (
    <section className="grid grid-cols-2 gap-4 px-4 pt-10 lg:hidden">
      ...
      >
        <span className="font-normal leading-4 text-[15px] tracking-[-0.005em]">Filters</span>
      ...
      <Button
        ...
        className="flex justify-between items-center py-4 px-4 w-full h-14"
      >
        <span className="font-normal leading-4 text-[15px] tracking-[-0.005em]">By Rating</span>
